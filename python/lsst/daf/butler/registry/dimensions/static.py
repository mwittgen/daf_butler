...
class StaticDimensionRecordStorageManager(DimensionRecordStorageManager):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(universe=sql_engine.universe)
        self._db = db
    ...
    def initialize(
        ...
        *,
        ...
        for dimension in universe.getGovernorDimensions():
            governorStorage = dimension.makeStorage(db, context=context, sql_engine=sql_engine)
        ...
        for element in universe.getDatabaseElements():
            elementStorage = element.makeStorage(
                db, context=context, governors=governors, sql_engine=sql_engine
            )
